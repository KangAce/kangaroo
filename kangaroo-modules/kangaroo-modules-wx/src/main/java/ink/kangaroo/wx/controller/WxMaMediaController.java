...
//     */
//    @PostMapping("/upload")
//    public AjaxResult uploadMedia(@PathVariable String appid, HttpServletRequest request) throws WxErrorException {
//        final WxMaService wxService = WxMaConfiguration.getMaService(appid);
//
//        CommonsMultipartResolver resolver = new CommonsMultipartResolver(request.getSession().getServletContext());
//
//        if (!resolver.isMultipart(request)) {
//            return AjaxResult.createAjaxResult(Lists.newArrayList());
//        }
//
...
//        }
//
//        return AjaxResult.createAjaxResult(result);
//    }
//
//    /**
//     * 下载临时素材
...
//    public AjaxResult getMedia(@PathVariable String appid, @PathVariable String mediaId) throws WxErrorException {
//        final WxMaService wxService = WxMaConfiguration.getMaService(appid);
//
//        return AjaxResult.createAjaxResult(wxService.getMediaService().getMedia(mediaId));
//    }
//}
