...
//import ink.kangaroo.common.security.service.TokenService;
...
//            return AjaxResult.fail("修改用户'" + user.getUserName() + "'失败，手机号码已存在");
//        } else if (StringUtils.isNotEmpty(user.getEmail())
//                && UserConstants.NOT_UNIQUE.equals(userService.checkEmailUnique(user))) {
//            return AjaxResult.fail("修改用户'" + user.getUserName() + "'失败，邮箱账号已存在");
//        }
...
//                return AjaxResult.fail("文件服务异常，请联系管理员");
//            }
