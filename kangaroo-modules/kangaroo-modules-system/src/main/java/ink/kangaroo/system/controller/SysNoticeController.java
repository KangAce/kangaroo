...
import ink.kangaroo.system.domain.SysNotice;
import ink.kangaroo.system.service.ISysNoticeService;
...
public class SysNoticeController extends BaseController {
    ...
    public AjaxResult getInfo(@PathVariable Long noticeId) {
        return AjaxResult.success().setData(noticeService.selectNoticeById(noticeId));
    }
