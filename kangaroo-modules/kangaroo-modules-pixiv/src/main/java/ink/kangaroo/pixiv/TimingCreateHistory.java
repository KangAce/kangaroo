 ...
 */
@Data
@Document(value = "timing_create_history")
public class TimingCreateHistory implements Serializable {
    ...
    /**
     * 状态(0:未开始, 1:正在复制, 2:已完成) {@link com.xjcod.marketing.tencent.enums.CopyTaskEnum}
     */
    @Field("state")
