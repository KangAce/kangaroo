...
public class GlobalExceptionHandler {
    ...
    public AjaxResult handlePreAuthorizeException(PreAuthorizeException e, HttpServletRequest request) {
        ...
        return AjaxResult.fail(HttpStatus.FORBIDDEN, "没有权限，请联系管理员授权");
    }
    ...
    public AjaxResult handleServiceException(ServiceException e, HttpServletRequest request) {
        ...
        return StringUtils.isNotNull(code) ? AjaxResult.fail(code, e.getMessage()) : AjaxResult.fail(e.getMessage());
    }
