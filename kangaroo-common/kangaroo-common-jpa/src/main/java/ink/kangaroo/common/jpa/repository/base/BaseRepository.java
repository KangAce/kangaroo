package ink.kangaroo.common.jpa.repository.base;
...
@NoRepositoryBean
@Repository
public interface BaseRepository<DOMAIN, ID> extends JpaRepository<DOMAIN, ID>, JpaSpecificationExecutor<DOMAIN>, PagingAndSortingRepository<DOMAIN, ID> {
